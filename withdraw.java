...
public class withdraw extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (uid.equals(jTextField1.getText())) {
            ...
            try {
                int test = new dbConnection().check(Float.parseFloat(jTextField2.getText()), uid);
                if (test == 1) {
                    new dbConnection().transection(jTextField1.getText(), "-" + jTextField2.getText());
                    jLabel4.setText("Collect Your Money");
                } else {
                    jLabel4.setText("Insufficient Fund...!");
                }
            } catch (Exception ex) {
                Logger.getLogger(payin.class.getName()).log(Level.SEVERE, null, ex);
            }

        } else {
            System.out.println("wrong id...!");
            jLabel4.setText("Wrong UserID...!");
        }
