...
public class payin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Pay In Account");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (uid.equals(jTextField1.getText())) {
            String query = "insert into `" + jTextField1.getText() + "`(`Date`,`From`,`To`,`Mode`,`Amount`,`Interest`) values('" + java.time.LocalDate.now()
                    + "','Self','Self','Credit'," + jTextField2.getText() + ",0);";
            try {
                new dbConnection().transection(jTextField1.getText(),jTextField2.getText());
                jLabel4.setText("Payed Successfully.");
            } catch (Exception ex) {
                System.out.println("pay error "+ex);
                jLabel4.setText("Give Valid Input.");
            }
